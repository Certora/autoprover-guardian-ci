import type { AissRunReport, AissRunOutcome, AuditFindings, CommitGeneratedFilesResponse, Finding, FindingValidationReport, PublicReport } from "./types";
...
export declare function formatPrComment(findings: AuditFindings, runId: string, cost: number | null, issueLinks: {
    finding: Finding;
    url: string;
}[], prNumber: number, workflow: "ai-auditor-full" | "ai-auditor-diff"): string;
