...
export type RunRequest = AiAuditorFullRunRequest | AiAuditorDiffRunRequest | AiAuditorFindingValidationRunRequest | StandaloneRunRequest;
...
export type FindingValidationReport = {
    ...
    consensus_method: "unanimous_valid" | "unanimous_invalid" | "tiebreaker_valid" | "tiebreaker_invalid";
...
export type ActionConfig = AiAuditorActionConfig | FindingValidationActionConfig | StandaloneActionConfig;
export declare function workflowEngine(workflow: Workflow): Engine;
export declare function workflowRunType(workflow: Workflow): RunType;
export {};
